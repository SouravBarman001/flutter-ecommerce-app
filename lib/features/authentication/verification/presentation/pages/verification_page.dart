    ...
    return showDialog<void>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          actions: <Widget>[
            TextButton(
              child: const Text('Closed',style: AppTextStyle.smallTextOne,),
              onPressed: () {
                setState(() {
                  pinController.text = '';
                  _timer.cancel();
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              ...
                              child: Text(
                                'Re-send Code',
                                style: AppTextStyle.textStyleOne(Colors.blue, 14.0, FontWeight.w500),
                              ),
                            ),
                          ],
                        ),
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: Text(
                            'Continue',
                            style: AppTextStyle.textStyleOne(
                                Colors.white, 14.0, FontWeight.w600),
                          ),
                        ),
                      ),
