...
import '../../../home_core/data/domain/FeaturedProductModel.dart';
import '../../../home_core/presentation/pages/best_sellers.dart';
import '../../../home_core/presentation/pages/new_arrival.dart';
              ...
              child: Container(
                ...
                child: Text(
                  ...
                  style: AppTextStyle.textStyleOne(
                       Colors.black, 16.0, FontWeight.w700),
                ),
              ),
            ),
            const Expanded(
                                ...
                                ListView.builder(
                                 // reverse: true,
                                  ...
                                  itemBuilder: (BuildContext context, int index) {
                                    int reversedIndex = _recentSearches.length - 1 - index;
                                    return Container(
                                      child: Row(
                                           ...
                                           Expanded( flex: 3,
                                               child: Row(
                                                 ...
                                                 children: [
                                                   ...
                                                   Text(_recentSearches[reversedIndex]),
                                           ],)),
                                          Expanded(
                                            flex : 1,
                                            child: Container(
                                              ...
                                              child: IconButton(
                                                  ...
                                                  onPressed: () {
                                                    setState(() {
                                                      _recentSearches.removeAt(reversedIndex);
                                                    });
                                                  },
                                                ),
                                            ),
